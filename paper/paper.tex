...
We conducted comprehensive steering experiments on Qwen2.5-7B (safety-trained) and Dolphin-Llama-3.1-8B (uncensored) across multiple layers and scenarios. Table~\ref{tab:steering} presents success rates demonstrating distinct steering patterns between safety-trained and uncensored models.
