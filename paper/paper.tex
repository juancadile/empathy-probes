...
\caption{Empathy detection performance (AUROC) across transformer layers. Layer 12 achieves perfect discrimination (AUROC = 1.0). The probe effectively separates empathic from non-empathic text across middle layers (8-16), with performance degrading in deeper layers.}
